...
public class Dates {
     ...
     */
    public static boolean isSameDay(Date date1, Date date2, TimeZone zone) {
     ...
     * @throws IllegalArgumentException if the date is <code>null</code>
     */
    public static boolean isBeforeDay(Date date1, Date date2, TimeZone zone) {
        if (date1 == null || date2 == null) {
            throw new IllegalArgumentException("The dates must not be null");
        }
        Calendar cal1 = getCalendarInstance(zone);
     ...
     * @throws IllegalArgumentException if the date is <code>null</code>
     */
    public static boolean isAfterDay(Date date1, Date date2, TimeZone zone) {
        if (date1 == null || date2 == null) {
            throw new IllegalArgumentException("The dates must not be null");
        }
        Calendar cal1 = getCalendarInstance(zone);
     ...
     * @throws IllegalArgumentException if the date is <code>null</code>
     */
    public static boolean isWithinDaysFuture(Date date, int days, TimeZone zone) {
        if (date == null) {
     ...
     * @throws IllegalArgumentException if the calendar is <code>null</code>
     */
    public static boolean isWithinDaysFuture(Calendar cal, int days, TimeZone zone) {
        if (cal == null) {
            throw new IllegalArgumentException("The date must not be null");
        }
    ...
    public static Date getStart(Date date, TimeZone zone) {
        return clearTime(date, zone);
    }
    
    /** Returns the given date with the time values cleared. */
    public static Date clearTime(Date date, TimeZone zone) {
        if (date == null) {
            return null;
        }
     ...
     */
    public static boolean hasTime(Date date, TimeZone zone) {
        if (date == null) {
            return false;
        }
        Calendar c = getCalendarInstance(zone);
    ...
    public static Date getEnd(Date date, TimeZone zone) {
        if (date == null) {
            return null;
        }
